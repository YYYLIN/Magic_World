...
/*
			...
			for (EntityX::Entity _entity : _es.entities_with_components<ObjectSupervisor>(_ObjectSupervisor))
			{
				_ObjectSupervisor->m_Supervisor.m_systems.Update<ObjectUpdataSystem>(_time);
			}*/
		}
